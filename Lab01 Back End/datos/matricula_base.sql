...
--INSERTAR
CREATE OR REPLACE PROCEDURE INSERTAR_CURSO(CODIGO IN CURSO.CODIGO%TYPE, NOMBRE IN CURSO.NOMBRE%TYPE, CREDITOS IN CURSO.CREDITOS%TYPE, HORAS_SEMANALES IN CURSO.HORAS_SEMANALES%TYPE)

AS

BEGIN

INSERT INTO CURSO VALUES(SEC_CURSO.nextval, CODIGO, NOMBRE, CREDITOS, HORAS_SEMANALES, 1);
COMMIT;
...
--MODIFICAR
CREATE OR REPLACE PROCEDURE MODIFICAR_CURSO(P_CODIGO IN CURSO.CODIGO%TYPE, P_NOMBRE IN CURSO.NOMBRE%TYPE, P_CREDITOS IN CURSO.CREDITOS%TYPE, P_HORAS_SEMANALES IN CURSO.HORAS_SEMANALES%TYPE)

AS

BEGIN

UPDATE CURSO SET NOMBRE = P_NOMBRE, CREDITOS = P_CREDITOS, HORAS_SEMANALES = P_HORAS_SEMANALES WHERE CODIGO = P_CODIGO;
COMMIT;
